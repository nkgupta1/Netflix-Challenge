...
if __name__=='__main__':
    ...
    vfile = "../../data/lf/0.917174_50_0.007000_0.050000_71_v"
    ufile = "../../data/lf/0.917174_50_0.007000_0.050000_71_u"
    afile = "../../data/lf/0.917174_50_0.007000_0.050000_71_a"
    bfile = "../../data/lf/0.917174_50_0.007000_0.050000_71_b"
    # print("How long?")
    # X = np.array([[1],[2]])
    # Y = np.array([1,2])
    # rvm.fit(X,Y)
    # print("All is peachy")
    # Yprime = rvm.predict(np.array([[2]]))
    # print(Yprime)